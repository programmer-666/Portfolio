    ...
    function filterPosts() {
        if (selectedTags.length === 0) {
            ...
            $('.card.mb-3').each(function() {
                ...
                var postTags = $(this).find('.badge').map(function() {
            ...
            if (postCount === 0) {
                ...
                if ($('#no-posts-message').length === 0) {
                    $('.col-lg-9.col-md-8').append('<p id="no-posts-message" style="margin-top: 6rem;" class="h6 user-select-none d-flex justify-content-center align-items-center text-body-secondary">Post Bulunamadı</p>');
                }
            } else {
